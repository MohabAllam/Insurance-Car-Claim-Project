...
# st.title('Car Insurance Classification Project')
...
new_data = pd.DataFrame(data= [[kidsdriv, age, homekids, yoj, income, parent1, home_val,
            ...
            columns= df.columns.drop('claim_flag'))
